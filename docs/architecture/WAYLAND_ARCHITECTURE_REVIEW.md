# ORNAS V2 — Wayland Architecture Review

## 1. Objective
Perform a complete audit of the existing Wayland clipboard implementation in ORNAS V2, analyzing the clipboard flow, GTK integration, polling strategy, ownership model, and interaction with the ORNAS pipeline.

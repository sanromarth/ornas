# ORNAS — Wayland Blocking Analysis

## 1. Objective
Determine whether the synchronous GTK clipboard APIs used in ORNAS block the main UI thread and assess the worst-case latency scenarios under Wayland.

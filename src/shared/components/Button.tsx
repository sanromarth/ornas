...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap font-medium transition-all duration-100 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background active:scale-[0.97] active:opacity-90 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
